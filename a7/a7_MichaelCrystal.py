...
def calculate_clusters(pixels, cluster_count=5):
	...
	if SKIP_OPENCV:
		# Return 5 clusters for the first cat
		fake_clusters = [(181, 200, 218), (50, 50, 44), (146, 135, 109), (214, 212, 195), (166, 163, 149), (245, 247, 246), (95, 94, 87), (18, 21, 17), (123, 127, 126), (64, 62, 54), (142, 157, 173), (78, 77, 69), (37, 37, 32), (120, 115, 102), (179, 177, 167), (111, 124, 159), (154, 174, 199), (99, 105, 113), (225, 225, 213), (111, 145, 228), (147, 146, 136), (198, 195, 181), (200, 205, 206), (206, 217, 222), (171, 187, 201)]
		return fake_clusters[0:cluster_count]
...
class Cat_Picture:
	...
	def detect_cats(self):
		...
		if SKIP_OPENCV:
			self.detected_cats = [[220, 96, 144, 144]]
			return None
